...
$router->get('/wiki/{slug}.html', [WikiController::class, 'show']);
$router->post('/admin/wiki/kategori/kaydet', [AdminWikiController::class, 'saveCategory']);
$router->post('/admin/wiki/kategori/ana-sayfa', [AdminWikiController::class, 'setHomeCategory']);
$router->post('/admin/wiki/kategori/sil', [AdminWikiController::class, 'deleteCategory']);
$router->post('/admin/wiki/kategori/toggle', [AdminWikiController::class, 'toggleCategory']);
$router->post('/admin/wiki/icerik-tipi/kaydet', [AdminWikiController::class, 'saveContentType']);
$router->post('/admin/wiki/icerik-tipi/sil', [AdminWikiController::class, 'deleteContentType']);
$router->post('/admin/wiki/icerik-tipi/toggle', [AdminWikiController::class, 'toggleContentType']);
$router->post('/admin/wiki/icerik/kaydet', [AdminWikiController::class, 'savePage']);
$router->post('/admin/wiki/icerik/sil', [AdminWikiController::class, 'deletePage']);
$router->post('/admin/wiki/icerik/toggle', [AdminWikiController::class, 'togglePage']);
$router->post('/admin/wiki/icerik/resim', [AdminWikiController::class, 'uploadImage']);
